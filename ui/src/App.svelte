<script lang="ts">
  ...
  let localPath = '';
  // Blank is meaningful: it lets workspace/global configuration participate
  // instead of silently turning the release fallback into a GUI override.
  let localBase = '';
  let localOpenError = '';
  let githubPrUrl = '';
  let sshTarget = '';
